...
5. Review the code for unused and dead code, duplicated code, unsafe code, and inconsistencies.
6. Present a plan before continuing.
7. Once completed, ensure the package version is updated, build the project, update the changelog, readme, and provide a commit message.
