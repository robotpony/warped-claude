...
4. After drafting, do a self-check against the anti-patterns in the rules:
   - No symbolic inflation, no "not X but Y" structures, no vague intensifiers
   - Vary sentence and list lengths
   - No meta-commentary ("as we've explored...")
5. Present the draft with a brief note on anything flagged or left as a placeholder
